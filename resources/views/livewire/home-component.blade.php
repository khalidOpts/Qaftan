                                    ...
                                    <div class="row align-items-center slider-animated-1">
                                        <div class="col-lg-5 col-md-6">
                                            <div class="hero-slider-content-2">
                                                ...
                                                <a class="animated btn btn-brush btn-brush-3" href="product-details.html">{{$Slide->link}}</a>
                                            </div>
                                        </div>
                                        <div class="col-lg-7 col-md-6">
                                            <div class="single-slider-img single-slider-img-1">
                                                <img class="animated slider-1-1" src="{{asset('assets/imgs/sliders')}}/{{$Slide->image}} " alt="{{$Slide->title}}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
