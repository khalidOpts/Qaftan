                                ...
                                <tbody>
                                    ...
                                    @foreach ($slides as $slide)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{route('admin.Home.edit',['slide_id'=>$slide->id])}}" class="text-info">Edit</a>
                                                    <a href="#" onclick="deleteConfirmation({{$slide->id}})" style="margin-left: 20px" class="text-danger">Delete</a>
                                                </td>
                                            </tr>
                                    @endforeach
                                </tbody>
